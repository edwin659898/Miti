		...
		<div class="fb5" id="fb5">      
			...
			<section id="config">
			  <ul>
				...
				<li key="rtl">false</li>
				@if(isset($magazine))					<!-- enabled/disabled 'right to left' for eastern countries -->
				  <li key="pdf_url">/files/magazines/{{$magazine->file}}</li>	
				@else
				  <li key="pdf_url">/files/articles/{{$articles->file}}</li>	
				@endif<!-- pathway to a pdf file ( the file will be read live ) -->
				...
				<div class="fb5-menu" id="fb5-center">
					<ul>
						...
						<li>
							...
							@else
							  <a title="download pdf" class="fb5-download" href="{{ asset('files/articles/'.$article->file) }}"><i class="fa fa-download"></i></a>
							@endif
						</li>
