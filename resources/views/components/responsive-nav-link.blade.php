...
$classes = ($active ?? false)
            ...
            : 'block pl-3 pr-4 py-2 border-l-4 cursor-pointer border-transparent text-base font-medium text-white hover:text-blue-500 hover:bg-blue-50 hover:border-gray-300 focus:outline-none  transition duration-150 ease-in-out';
@endphp
